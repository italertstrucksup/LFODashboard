...
namespace VendorService.DAL.Repository
{
    public class PanDAL : IPanDal
    {
        ...
        public PanDAL(IHttpService httpService, IConfiguration config, CL_JWTtokenGeneration cL_JWTtoken)
        {
        ...
        {
            ApiResponse<PanApiResponse> apiResponse1 = new ApiResponse<PanApiResponse>();
            ...
            var apiResponse = await _httpService
                  .PostAsync<object, PanApiResponse>(apiUrl, requestBody, headers);
